		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(sid==null||sid.trim().equals("")){
					JOptionPane.showMessageDialog(DeleteExam.this,"Id can't be blank");
				}else{
					int id=Integer.parseInt(sid);
					int i=ExamDao.delete(id);
					if(i>0){
						JOptionPane.showMessageDialog(DeleteExam.this,"Record deleted successfully!");
					}else{
						JOptionPane.showMessageDialog(DeleteExam.this,"Unable to delete given id!");
					}
				}
			}
		});
